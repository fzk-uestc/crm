...
<head>
    ...
    <script type="text/javascript">
        ...
        $(function () {
            ...
            //页面加载完毕后，展现该线索关联的备注信息列表和关联的市场活动列表
            showRemarkList();
            showActivityList();
            ...
            //弹出"关联市场活动"modal窗口:
            $("#relationEditBtn").click(function () {
                //清空tbody
            ...
            //为关联市场活动模态窗口中的搜索框绑定键盘事件
            $("#activityName").keydown(function (event) {
                //如果是回车键
                if (event.keyCode == 13) {
                    //发送ajax请求，处理查询请求
                    $.ajax({
                        url: "workbench/clue/getActivityListByNameAndNotRelationClueId.do",
                        data: {
                    ...
                    //展现完列表后，必须将模态窗口的默认的回车行为禁用掉
                    return false;
                }
            });
            $("#relationSaveBtn").click(function () {
                //首先要找到打√了的市场活动
        ...
        function unbund(relationId) {
            if (!window.confirm("你确定要解除关联吗？")) {
                return false;
            }
            $.ajax({
    ...
    <div class="modal-dialog" role="document" style="width: 80%;">
        <div class="modal-content">
            ...
            <div class="modal-footer">
                ...
                <button type="button" class="btn btn-primary" id="relationSaveBtn">关联</button>
            </div>
        </div>
    </div>
</div>
...
<div style="position: relative; left: 40px; top: -30px;">
    ...
    <div style="position: relative; height: 50px; width: 500px;  top: -72px; left: 700px;">
        <button type="button" class="btn btn-default" onclick="window.location.href='workbench/clue/convert.jsp?clueId=${clue.id}&fullname=${clue.fullname}&appellation=${clue.appellation}&company=${clue.company}&owner=${clue.owner}';"><span
...
<div>
    <div style="position: relative; top: 60px; left: 40px;">
        ...
        <div>
            <a id="relationEditBtn" href="javascript:void(0);" style="text-decoration: none;"><span
